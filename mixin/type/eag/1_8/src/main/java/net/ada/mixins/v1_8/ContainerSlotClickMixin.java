...
import net.ada.v1_8.event.ContainerSlotClickEvent;
...
public class ContainerSlotClickMixin {
    ...
    private void herz$slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn) {
        EventBus.INSTANCE.post(new ContainerSlotClickEvent((Container) (Object) this, slotId, clickedButton, playerIn));
    }
}
